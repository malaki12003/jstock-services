...
/**
 * To test the sell slope test. Es válido si la seerie está subiendo en los
 * últimos 20 días, y en los últimos 5 días es más pronunciada que en los
 * últimos 10.
 * 
 * @author Pablo
 * 
 */
public class SellSlopeStairValidAnalyzerFunction extends
